...
Column selection is the same as for matrices. 
...
The result is a list. The timeseries in this list can be combined with a combination of functions `cbind` and `do.call` ^[Notice the ordering of the columns: the column names are in reversed order!]:
