...
test_that("change_frequency.period", {
  ...
  expect_identical(as.character(change_frequency(p, 12)), "2017M3")

  p <- period("2017M4")
  expect_identical(as.character(change_frequency(p, 1)), "2017")
  expect_identical(as.character(change_frequency(p, 2)), "2017-1")
  expect_identical(as.character(change_frequency(p, 4)), "2017Q2")
  expect_identical(as.character(change_frequency(p, 12)), "2017M4")

  p <- period("2017M8")
  expect_identical(as.character(change_frequency(p, 1)), "2017")
  expect_identical(as.character(change_frequency(p, 2)), "2017-2")
  expect_identical(as.character(change_frequency(p, 4)), "2017Q3")
  expect_identical(as.character(change_frequency(p, 12)), "2017M8")
...
test_that("change_frequency.period_range", {
  ...
  expect_identical(as.character(change_frequency(r, 12)), "2017M3/2018M5")
  ...
  expect_identical(as.character(change_frequency(r, 12)), "/2018M8")

  r <- period_range("2017Q3/2018Q2")
  expect_identical(as.character(change_frequency(r, 12)), "2017M7/2018M6")

  r <- period_range("2017Q1/2018Q1")
  expect_identical(as.character(change_frequency(r, 12)), "2017M1/2018M3")

  r <- period_range("2017")
  expect_identical(as.character(change_frequency(r, 1)), "2017")
  expect_identical(as.character(change_frequency(r, 4)), "2017Q1/2017Q4")
  expect_identical(as.character(change_frequency(r, 12)), "2017M1/2017M12")
