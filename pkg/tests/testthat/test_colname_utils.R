...
test_that("rename_cols", {
  ...
  # with named character vector
  data_renamed_2a <- rename_cols(data, c(y = "b", p = "a",  x = "a"))
  expect_identical(data_renamed_2a, expected_result)
