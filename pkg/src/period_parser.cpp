...
/* Line 189 of yacc.c  */
#line 19 "lex_yacc/period_parser.yy"
...
{
      11,     0,    -1,    12,    -1,    13,    -1,    16,    -1,    17,
      -1,    18,    -1,    19,    -1,    15,     3,    -1,    15,     3,
       5,    -1,     5,     3,    -1,     7,    -1,    -1,     6,    -1,
      -1,    15,     3,    14,     3,     4,    -1,     5,     3,    14,
       3,     4,    -1,     4,     3,    14,     3,    -1,    15,     3,
       7,     4,     3,    -1,     5,     3,     7,     4,     3,    -1,
      15,     3,     4,     7,     3,    -1,     5,     3,     4,     3,
      -1,    15,     3,     4,     3,    -1,     5,     3,    14,     3,
      -1,    15,     3,    14,     3,    -1,     8,    14,     3,    -1
};
...
static const char *const yytname[] =
{
  ...
  "no_periodicity_1", "no_periodicity_2", "month", 0
};
#endif
...
/* Line 1455 of yacc.c  */
#line 59 "lex_yacc/period_parser.yy"
    {year = (yyvsp[(2) - (2)]); freq = 1; subperiod = 1;;}
    break;

  case 9:

/* Line 1455 of yacc.c  */
#line 62 "lex_yacc/period_parser.yy"
    {year = (yyvsp[(2) - (3)]); freq = 1; subperiod = 1;;}
    break;

  case 10:

/* Line 1455 of yacc.c  */
#line 64 "lex_yacc/period_parser.yy"
    {year = (yyvsp[(2) - (2)]); freq = 1; subperiod = 1;;}
    break;
...
/* Line 1455 of yacc.c  */
#line 76 "lex_yacc/period_parser.yy"
    {year = (yyvsp[(2) - (5)]); subperiod = (yyvsp[(4) - (5)]); freq = (yyvsp[(5) - (5)]);;}
    break;

  case 16:

/* Line 1455 of yacc.c  */
#line 78 "lex_yacc/period_parser.yy"
    {year = (yyvsp[(2) - (5)]); subperiod = (yyvsp[(4) - (5)]); freq = (yyvsp[(5) - (5)]);;}
    break;
...
/* Line 1455 of yacc.c  */
#line 80 "lex_yacc/period_parser.yy"
    {year = (yyvsp[(4) - (4)]); subperiod = (yyvsp[(2) - (4)]); freq = (yyvsp[(1) - (4)]);;}
    break;

  case 18:

/* Line 1455 of yacc.c  */
#line 82 "lex_yacc/period_parser.yy"
    {year = (yyvsp[(2) - (5)]); subperiod = (yyvsp[(5) - (5)]); freq = (yyvsp[(4) - (5)]);;}
    break;

  case 19:

/* Line 1455 of yacc.c  */
#line 84 "lex_yacc/period_parser.yy"
    {year = (yyvsp[(2) - (5)]); subperiod = (yyvsp[(5) - (5)]); freq = (yyvsp[(4) - (5)]);;}
    break;
...
/* Line 1455 of yacc.c  */
#line 86 "lex_yacc/period_parser.yy"
    {year = (yyvsp[(5) - (5)]); subperiod = (yyvsp[(2) - (5)]); freq = (yyvsp[(3) - (5)]);;}
    break;

  case 21:

/* Line 1455 of yacc.c  */
#line 88 "lex_yacc/period_parser.yy"
    {year = (yyvsp[(2) - (4)]); subperiod = (yyvsp[(4) - (4)]); freq = (yyvsp[(3) - (4)]);;}
    break;

  case 22:

/* Line 1455 of yacc.c  */
#line 94 "lex_yacc/period_parser.yy"
    {year = (yyvsp[(2) - (4)]); subperiod = (yyvsp[(4) - (4)]); freq = (yyvsp[(3) - (4)]);
...
/* Line 1455 of yacc.c  */
#line 99 "lex_yacc/period_parser.yy"
    {year = (yyvsp[(2) - (4)]); subperiod = (yyvsp[(4) - (4)]);;}
    break;

  case 24:

/* Line 1455 of yacc.c  */
#line 106 "lex_yacc/period_parser.yy"
    {year = (yyvsp[(2) - (4)]); subperiod = (yyvsp[(4) - (4)]);
                if (!ISNA(given_freq)) {
...
/* Line 1455 of yacc.c  */
#line 113 "lex_yacc/period_parser.yy"
    {year = (yyvsp[(3) - (3)]); subperiod = (yyvsp[(1) - (3)]); freq = 12;;}
    break;



/* Line 1455 of yacc.c  */
#line 1464 "period_parser.cpp"
      default: break;
    }
...
/* Line 1675 of yacc.c  */
#line 116 "lex_yacc/period_parser.yy"
