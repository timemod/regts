...
static const yytype_int8 yyrhs[] =
{
      ...
      -1,    16,    -1,     3,    -1,     3,     5,    -1,     6,    -1,
      -1,     3,    13,     3,     4,    -1,     4,     3,    13,     3,
      -1,     3,     6,     4,     3,    -1,     3,     4,     6,     3,
      -1,     3,     4,     3,    -1,     3,    13,     3,    -1,     7,
      13,     3,    -1
};
...
static const char *const yytname[] =
{
  ...
  "y_period", "opt_sep", "qm_period", "no_periodicity", "month", 0
};
#endif
...
/* Line 1455 of yacc.c  */
#line 56 "lex_yacc/period_parser.yy"
    {year = (yyvsp[(1) - (1)]); freq = 1; subperiod = 1;;}
    break;
...
#line 59 "lex_yacc/period_parser.yy"
    {year = (yyvsp[(1) - (2)]); freq = 1; subperiod = 1;;}
    break;

  case 11:

/* Line 1455 of yacc.c  */
#line 67 "lex_yacc/period_parser.yy"
    {year = (yyvsp[(1) - (4)]); subperiod = (yyvsp[(3) - (4)]); freq = (yyvsp[(4) - (4)]);;}
    break;

  case 12:

/* Line 1455 of yacc.c  */
#line 69 "lex_yacc/period_parser.yy"
...
/* Line 1455 of yacc.c  */
#line 71 "lex_yacc/period_parser.yy"
    {year = (yyvsp[(1) - (4)]); subperiod = (yyvsp[(4) - (4)]); freq = (yyvsp[(3) - (4)]);;}
    break;

  case 14:

/* Line 1455 of yacc.c  */
#line 73 "lex_yacc/period_parser.yy"
    {year = (yyvsp[(4) - (4)]); subperiod = (yyvsp[(1) - (4)]); freq = (yyvsp[(2) - (4)]);;}
    break;

  case 15:

/* Line 1455 of yacc.c  */
#line 75 "lex_yacc/period_parser.yy"
    {year = (yyvsp[(1) - (3)]); subperiod = (yyvsp[(3) - (3)]); freq = (yyvsp[(2) - (3)]);
...
#line 82 "lex_yacc/period_parser.yy"
    {year = (yyvsp[(1) - (3)]); subperiod = (yyvsp[(3) - (3)]);
                if (!ISNA(given_freq)) {
...
/* Line 1455 of yacc.c  */
#line 89 "lex_yacc/period_parser.yy"
...
/* Line 1675 of yacc.c  */
#line 92 "lex_yacc/period_parser.yy"
