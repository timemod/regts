...
Almost all functions work exactly the same for `regts` and `ts`. The only exceptions are `cbind` (discussed below) and `aggregate` ( described in vignette _Temporal aggregation of (growth) timeseries_).
