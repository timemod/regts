...
periods. Such a range can be created in the following way:
...
By changing indices in the two inner summations this can be simplified 
considerably. Set $j=i+k$ in the first inner sum and $j=i+k-n$ in the second 
